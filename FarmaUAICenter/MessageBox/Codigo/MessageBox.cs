        ...
        public string Show(object sender)
        {
            ...
            switch (this.MessageIcons)
            {
                ...
                case MessageBoxIcons.Warnning:
                    iconUrl = "<img src ='../MessageBox/Imagenes/1.jpg' />";
                    break;
                case MessageBoxIcons.Error:
                    iconUrl = "<img src ='../MessageBox/Imagenes/2.jpg' />";
                    break;
                case MessageBoxIcons.Question:
                    iconUrl = "<img src ='../MessageBox/Imagenes/3.jpg' />";
                    break;
                case MessageBoxIcons.System:
                    iconUrl = "<img src ='../MessageBox/Imagenes/4.jpg' />";
                    break;
            }
